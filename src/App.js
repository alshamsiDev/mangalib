  ...
  render() {
    ...
    return (
      <Router>
        ...
        <>
          <Switch>
            <Route exact path='/' component={() => <AnimeList counter={this.state.carts.length} topAnimes={this.state.animes} addNewAnime={this.addNewAnime}/>} removeAnime={this.removeAnime}/>
